...
\begin{subfigure}[t]{.45\textwidth}
  \centering
  \fbox{\includegraphics[width=.9\textwidth]{sings1fulltree.png}}
  \label{fig:sub1}
\end{subfigure}%\usepackage[nottoc,numbib]{tocbibind}
\begin{subfigure}[t]{.45\textwidth}
  \centering
  \fbox{\includegraphics[width=.9\textwidth]{sings1sometree.png}}
  \label{fig:sub2}
\end{subfigure}
